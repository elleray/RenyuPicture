...
public class StorageManager {
    ...
    // 判断存储空间是否足够的文件尺寸倍数
    private final float FILE_SIZE_FRACTION = 1.0f;
    // 判断存储空间是否足够的额外尺寸数
    ...
    // 定义一系列文件夹名称
    private final String DIR_GODAP = "人鱼图库";
    private final String DIR_TRANSFER = "transfer";
    private final String DIR_TRANSFER_VIDEO = "video";
    private final String DIR_TRANSFER_AUDIO = "audio";
    private final String DIR_TRANSFER_PICTURE = "image";
    private final String DIR_TRANSFER_AVATAR = "tmp_avatar";
    private final String DIR_PICTURE = "picture";
    private final String DIR_DOCUMENT = "document";
    private final String DIR_DOWNLOAD = "download";
    private final String DIR_DOWNLOAD_VIDEO = "video";
    private final String DIR_DOWNLOAD_AUDIO = "music";
    private final String DIR_DOWNLOAD_FILES = "files";
    private final String DIR_CACHE = "cache";
    private final String DIR_UPLOAD = "upload";
    ...
    private StorageManager(Context context) {
        ...
        Log.i(TAG, "StorageManager constructor: internalPath: " + mInternalRootPath + ", externalPath: " + mExternalRootPath);
    ...
    private String getStorageLocationConfigFilePath() {
        return Environment.getExternalStorageDirectory() + File.separator + DIR_GODAP + File.separator + DIR_CACHE + File.separator + FILE_NAME_LOCATION;
    }
    ...
    public String getInternalGoDapDirPath() {
        return mInternalRootPath + File.separator + DIR_GODAP + File.separator;
    }
